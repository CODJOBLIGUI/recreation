...
urlpatterns = [
    ...
    path(
        ...
        name='committee-portal',
    ),
    path(
        'lecture-evaluation-des-soumissions-de-manuscrit-ou-tapuscrits/inscription/',
        views.committee_signup,
        name='committee-signup',
    ),
    path(
        'lecture-evaluation-des-soumissions-de-manuscrit-ou-tapuscrits/<int:pk>/',
        views.committee_submission_detail,
